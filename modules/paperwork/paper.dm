...
//	t = copytext(sanitize(t),1,MAX_MESSAGE_LEN)
	...
	t = _replacetext(t, "\[sign\]", "<font face=\"[signfont]\"><i>[get_signature(P, user)]</i></font>")
	t = _replacetext(t, "\[field\]", "<span class=\"paper_field\"></span>")

	t = _replacetext(t, "\[h1\]", "<H1>")
	t = _replacetext(t, "\[/h1\]", "</H1>")
	t = _replacetext(t, "\[h2\]", "<H2>")
	t = _replacetext(t, "\[/h2\]", "</H2>")
	t = _replacetext(t, "\[h3\]", "<H3>")
	t = _replacetext(t, "\[/h3\]", "</H3>")
	...
	if(!iscrayon)
		...
		t = _replacetext(t, "\[/list\]", "</ul>")
		t = _replacetext(t, "\[table\]", "<table border=1 cellspacing=0 cellpadding=3 style='border: 1px solid black;'>")
		t = _replacetext(t, "\[/table\]", "</td></tr></table>")
		t = _replacetext(t, "\[grid\]", "<table>")
		t = _replacetext(t, "\[/grid\]", "</td></tr></table>")
		t = _replacetext(t, "\[row\]", "</td><tr>")
		t = _replacetext(t, "\[cell\]", "<td>")
		t = _replacetext(t, "\[logo\]", "<img src = ntlogo.png>")
		...
		t = _replacetext(t, "\[/list\]", "")
		t = _replacetext(t, "\[table\]", "")
		t = _replacetext(t, "\[/table\]", "")
		t = _replacetext(t, "\[row\]", "")
		t = _replacetext(t, "\[cell\]", "")
		t = _replacetext(t, "\[logo\]", "")
